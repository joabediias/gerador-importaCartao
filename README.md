...
```bash
python -m PyInstaller --noconfirm --clean --windowed --onefile --icon "assets/icons/app.ico" --add-data "templates/modelo_taxas_cartao.xlsx;templates" --add-data "assets;assets" desktop_app.py
```
