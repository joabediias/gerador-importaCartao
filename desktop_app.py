...
APP_NAME = "Gerador Importa Cartão"
...
class MainWindow(QMainWindow):
    ...
    def _build_output_box(self) -> QWidget:
        box = self._section_box("Pré-visualização")
        layout = box.layout()
    ...
    def _apply_styles(self) -> None:
        self.setStyleSheet(
            ...
            QMenuBar { background: #ffffff; border-bottom: 1px solid #dde6f0; }
            QGroupBox {
                background: #ffffff;
            ...
            QLabel { color: #24415f; font-size: 13px; }
            ...
            QStatusBar { background: #ffffff; color: #49637f; }
            QFrame#headerCard {
            ...
            QLabel#heroSubtitle { color: rgba(255,255,255,0.88); font-size: 14px; }
            QLabel#badge {
                color: #0d4b87;
            ...
            QLabel#metricTitle { color: #5b7590; font-size: 12px; }
